    ...
    emailjs
      .send(
        ...
        'template_1crx1wk',
        {
          ...
          to_email: "badjieansu165@gmail.com",
    ...
    >
      ...
      >
        ...
        >
          ...
          <h3>Call  <br />  <span className='ml-10'> +220 3338111 </span> </h3>



<div className='inset-0 flex justify-end card-img_hover'>
  <div
  onClick={() => window.open("https://www.instagram.com/ansu_0fficial/", "_blank")}
  ...
  <div className='w-20 h-20 rounded-full flex justify-center items-center cursor-pointer'>
    <div 
    onClick={() => window.open("https://www.tiktok.com/@ansu_0fficial", "_blank")}
    className='w-1/2 h-1/2 object-contain'>
      <img
        src={tiktok}
        alt='second image'
